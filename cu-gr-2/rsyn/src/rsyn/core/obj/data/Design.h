...
struct DesignData {  
	...
	robin_hood::unordered_map<std::string, Instance> instanceMapping;
	robin_hood::unordered_map<std::string, Net> netMapping;
	robin_hood::unordered_map<std::string, LibraryCell> libraryCellMapping;
